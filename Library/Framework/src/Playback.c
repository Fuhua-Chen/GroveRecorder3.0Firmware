...
// added by lambor for VR config
#define USER_PLAYBACK_VOLUME_MUTE          (0)
#define USER_PLAYBACK_VOLUME_NEG35_DB     (0.0178*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG30_DB     (0.0316*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG25_DB     (0.0562*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG20_DB     (0.1000*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG15_DB     (0.1778*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG10_DB     (0.3162*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG6_DB          (0.5012*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_NEG3_DB          (0.7079*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_0_DB          (1*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_1_DB          (1.2125*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_2_DB          (1.3125*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_3_DB          (1.4125*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_4_DB          (1.6125*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_6_DB          (1.9953*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_8_DB          (2.525*(1<<PLAYBACK_VOLUME_FINE_SHIFT))
#define USER_PLAYBACK_VOLUME_10_DB          (3.1623*(1<<PLAYBACK_VOLUME_FINE_SHIFT))


extern volatile UINT8 g_u8AppCtrl;
extern volatile UINT8 g_adcVR2volume;  //added by lambor
...
#define PLAYBACK_SET_DB_SMOOTH	(300)     // def 300
...
void Playback_StartPlay(void)
{
	...
	if( s_u8PlayCtrl == PLAYBACK_NOACTION )
	{
		...
		if(g_adcVR2volume == 7){
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_10_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 6)
		{		
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_8_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 5)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_6_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 4)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_4_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 3)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_3_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 2)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_2_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 1)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_1_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 0)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_0_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 16)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG3_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 15)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG6_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 14)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG10_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 13)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG15_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 12)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG20_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 11)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG25_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 10)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG30_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 9)
		{
			Playback_SetVolumeDB(0, USER_PLAYBACK_VOLUME_NEG35_DB);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		...
		{
			Playback_SetVolumeDB(0, PLAYBACK_VOLUME_MUTE);
			printf("g_adcVR2volume = %d\n", g_adcVR2volume);
		}
		else if(g_adcVR2volume == 8)
		{
...
//		Playback_SetVolumeDB(0, PLAYBACK_VOLUME_NEG35_DB);   // added bylambor, choose which volume to use by VR
//		printf("g_adcVR2volume = %d\n", g_adcVR2volume);
