...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\bod.c"
...
void BOD_Open(uint8_t u8Mode, uint8_t u8BODLevel)
{
    ...
    ((BODTALM_T *) ((( uint32_t)0x40000000) + 0x84000))->BODSEL |= u8BODLevel;
    ((BODTALM_T *) ((( uint32_t)0x40000000) + 0x84000))->BODCTL |= u8Mode;
...
void BOD_Close(void)
{
    ((BODTALM_T *) ((( uint32_t)0x40000000) + 0x84000))->BODCTL &= (0x0);
}
...
void BOD_SetDetectionTime(uint8_t u8OnDUR, uint16_t u16OffDUR)
{
	((BODTALM_T *) ((( uint32_t)0x40000000) + 0x84000))->BODDTMR |= (u8OnDUR<<(16))&(0xful << (16));
	((BODTALM_T *) ((( uint32_t)0x40000000) + 0x84000))->BODDTMR |= (u16OffDUR&(0xfffful << (0)));
}
