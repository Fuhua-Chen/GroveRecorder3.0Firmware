...
#line 2 "..\\NuOneExApp\\NuOneExApp_Encode.c"
...
#line 3 "..\\NuOneExApp\\NuOneExApp_Encode.c"
...
#line 4 "..\\NuOneExApp\\NuOneExApp_Encode.c"
...
void NuOneExApp_EncodeInitiate(S_NUONEEX_APP_ENCODE *psNuOneExAppEncode, UINT8 *pu8EncodeTempBuf)
{
	...
	((&psNuOneExAppEncode ->sInBufCtrl)->u8Flag |= 2);
}
...
{
	if ( (eBitPerSample > E_NUONEEX_ENCODE_BPS_20) || (u16SampleRate == 0) )
		return 0;
	else
	{
	...
	psNuOneExAppEncode->sEncodeBufCtrl.u16BufCount = (psNuOneExAppEncode->sEncodeBufCtrl.u16FrameSize)*2;
...
BOOL NuOneExApp_EncodeProcess(S_NUONEEX_APP_ENCODE *psNuOneExAppEncode)
{
	...
	if ((((&psNuOneExAppEncode ->sInBufCtrl)->u8Flag & 2) != 0))
		return 0;
	...
	while(( psInBufCtrl->u16BufReadIdx > psInBufCtrl->u16BufWriteIdx )|| 
		(( psInBufCtrl->u16BufWriteIdx - psInBufCtrl->u16BufReadIdx)>= 320))
	{
		...
		if ((psInBufCtrl->u16BufReadIdx+=320) >= (2*320))
