...
#line 14 "..\\..\\..\\..\\Library\\StdDriver\\src\\CRC.c"
...
#line 15 "..\\..\\..\\..\\Library\\StdDriver\\src\\CRC.c"
...
int32_t CRC_Open(void)
{
		CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(19)));
		((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 | (0x1ul << (19)));
		((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 & (~(0x1ul << (19))));
...
int32_t CRC_Init(uint32_t eLSB, int32_t i32PacketLen)
{
    ...
    ((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->CTL = (((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->CTL | eLSB);
    if(i32PacketLen > 512)
        return -1;
    if(i32PacketLen%2==1)
        return -1;
    ((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->CTL = (((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->CTL & (~(0x1fful << (0))) | (i32PacketLen-1)); 
...
int16_t CRC_Calc( uint32_t *Data, int32_t i32PacketLen)
{
    ...
    while( i32PacketLen > 0){
		((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->DAT = *Data++;
		i32PacketLen-=4;
	}

    return ((CRC_T *) ((( uint32_t)0x40000000) + 0x90000))->CHECKSUM;
}
...
void CRC_Close(void)
{
		((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 | (0x1ul << (19)));
		((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST1 & (~(0x1ul << (19))));
		CLK_DisableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(19)));
}
