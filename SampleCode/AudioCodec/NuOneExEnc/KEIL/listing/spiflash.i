...
#line 7 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"
...
#line 8 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"
...
#line 28 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"


#line 37 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"

#line 46 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"

#line 58 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"
...
)
{
	...
	( (psSpiFlashHandler->psSpiHandler)->SSCTL = ( (psSpiFlashHandler->psSpiHandler)->SSCTL & ~(0x3ul << (0)) ) | psSpiFlashHandler->u8SlaveDevice );
		
	
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((u8DataLen == 32 ? 0:u8DataLen)<<(3)) );
	
	((psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x3ul << (8)) ) | (0x00ul << (8)));
	
	( (psSpiFlashHandler->psSpiHandler)->TX0 = u32Data );

	((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
	while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );

	
	( (psSpiFlashHandler->psSpiHandler)->SSCTL = ( (psSpiFlashHandler->psSpiHandler)->SSCTL & ~(0x3ul << (0)) ) | (0x0ul<<(0)) );
}
...
{
	return (SPIFlash_ReadStatusReg(psSpiFlashHandler, eSTATUS_REG1)& 0x01);
}
...
{
	while( SPIFlash_ReadStatusReg(psSpiFlashHandler, eSTATUS_REG1)& 0x01 );
}
...
)
{
	...
	SPIFlash_SendRecOneData(psSpiFlashHandler,(0x05|eStatusReg)<<8, 16);

	return (UINT8)((psSpiFlashHandler->psSpiHandler)->RX0);
}
...
{
	SPIFlash_ChipWriteEnable(psSpiFlashHandler, 1);

	SPIFlash_SendRecOneData(psSpiFlashHandler,(0x01<<8)|u8Status, 16);
...
#line 155 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"
	SPI_Open(psSpiFlashHandler->psSpiHandler, (0x0ul << (18)), ((0x1ul << (2))), u32SpiClk, 0);




	
	( (psSpiFlashHandler->psSpiHandler)->CTL &= ~(0x1ul << (10)) );
	
	( (psSpiFlashHandler->psSpiHandler)->CTL &= ~(0x1ul << (20)) );
	
	((psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x3ul << (8)) ) | (0x00ul << (8)));
	
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((8 == 32 ? 0:8)<<(3)) );
	
	( (psSpiFlashHandler->psSpiHandler)->SSCTL = ( (psSpiFlashHandler->psSpiHandler)->SSCTL & ~(0x1ul << (2)) ) | (0x0) );
	
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0xful << (12))) | (4 << (12)) );
...
)
{
	...
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((24 == 32 ? 0:24)<<(3)) );
	((psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x3ul << (8)) ) | (0x01ul << (8)));
	( (psSpiFlashHandler->psSpiHandler)->TX0 = ((UINT32)0x90<<16) );
	( (psSpiFlashHandler->psSpiHandler)->TX1 = 0 );
	((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
	while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
	u32Value = ((psSpiFlashHandler->psSpiHandler)->RX1);
	...
	SPIFlash_SendRecOneData(psSpiFlashHandler, (UINT32)0x9F<<24, 32);
	u32Value = ((psSpiFlashHandler->psSpiHandler)->RX0);
	...
	if(bW25P_SPIFlash)
	{
		psSpiFlashHandler->u8Flag = u8Flag|0x01;	
		return;
	}

	if ( u8DeviceID == 0x40 )
		u8Flag = u8Flag|0x01|0x02;
	else if ( u8DeviceID == 0x50 )
		u8Flag = u8Flag|0x01|0x02|0x04;
	else if ( u8DeviceID == 0x10 )
		u8Flag = u8Flag|0x01;
	else if( ((u32Value>>16)&0xff) == 0x1f ) 
		u8Flag = u8Flag|0x01|0x02|0x04;
	else
...
)
{
	...
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((32 == 32 ? 0:32)<<(3)) );
	((psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x3ul << (8)) ) | (0x00ul << (8)));
	( (psSpiFlashHandler->psSpiHandler)->TX0 = ((UINT32)0x02<<24)|u32ByteAddr );
	((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
	while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
...
)
{
	...
	( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((32 == 32 ? 0:32)<<(3)) );
	((psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x3ul << (8)) ) | (0x00ul << (8)));
	( (psSpiFlashHandler->psSpiHandler)->TX0 = ((UINT32)0x0B<<24)|(u32ByteAddr&0xffffff) );
	((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
	while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
...
)
{
    ...
    if (u8ProcBytes!=0)
    {
		...
		( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((u8ProcBytes<<3 == 32 ? 0:u8ProcBytes<<3)<<(3)) );
        ...
        while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
        u32ReadData = ((psSpiFlashHandler->psSpiHandler)->RX0);
    ...
    if (u32DataLen>0)
    {
        ( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((u32DataLen<<3 == 32 ? 0:u32DataLen<<3)<<(3)) );
...
)
{
	...
	do
	{
#line 568 "..\\..\\..\\..\\Library\\Storage\\src\\SPIFlash.c"
		((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
        while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
		*(UINT32 *)pu32Temp++ = ((psSpiFlashHandler->psSpiHandler)->RX0);
		*(UINT32 *)pu32Temp++ = ((psSpiFlashHandler->psSpiHandler)->RX1);
...
)
{
	...
	if ( ((UINT32)pau8Data)%4 )
	{
		...
		( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((u32ProcessByte*8 == 32 ? 0:u32ProcessByte*8)<<(3)) );
		u32WriteData = *pau8Data ++;
		if ( u32ProcessByte >= 2 )
			u32WriteData |= (*pau8Data ++)<<8;
		if ( u32ProcessByte == 3 )
			u32WriteData |= (*pau8Data ++)<<16;
		( (psSpiFlashHandler->psSpiHandler)->TX0 = u32WriteData );
		((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
		while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
	...
	{
		( (psSpiFlashHandler->psSpiHandler)->TX0 = *((PUINT32)pau8Data) );
		((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
		pau8Data += 4;
		u32WriteCount -= 4;
		while( ( ((psSpiFlashHandler->psSpiHandler)->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0 ) );
	...
	if (u32WriteCount)
	{
		...
		( (psSpiFlashHandler->psSpiHandler)->CTL = ((psSpiFlashHandler->psSpiHandler)->CTL & ~(0x1ful << (3)))|((u32WriteCount*8 == 32 ? 0:u32WriteCount*8)<<(3)) );
		u32WriteData = *pau8Data ++;
		if ( u32WriteCount >= 2 )
			u32WriteData |= (*pau8Data ++)<<8;
		if ( u32WriteCount == 3 )
...
{
	SPIFlash_ChipWriteEnable(psSpiFlashHandler, 1);
	SPIFlash_SendRecOneData(psSpiFlashHandler,0xC7,8);
}
...
)
{
	...
	do
	{
		...
		( (psSpiFlashHandler->psSpiHandler)->TX0 = *pu32Temp++ );
		( (psSpiFlashHandler->psSpiHandler)->TX1 = *pu32Temp++ );
		((psSpiFlashHandler->psSpiHandler)->CTL |= (0x1ul << (0)));
