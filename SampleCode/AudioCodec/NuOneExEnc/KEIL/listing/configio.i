...
#line 11 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
#line 1 "..\\ConfigApp.h"
...
#line 12 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
...
#line 13 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
#line 1 "..\\ConfigIO.h"
...
#line 14 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
#line 15 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"

S_KEYPAD_KEY_HANDLER const g_asMatrixKeyHandler[] = { {0, 0, 0, 0, 0, 0, 0} }; const UINT8 g_au8MatrixKeyStateIndex[] = {0};

S_KEYPAD_TGR_HANDLER const g_asTriggerKeyHandler[] = { {Default_KeyHandler, ((1)|0x20000000), 0x00000001, (1), (0)}, {Default_KeyHandler, ((1)|0x10000000), 0x00000001, (1), (1)}, {Default_KeyHandler, ((1)|0x40000000), 0x00000001, (1), (2)}, {Default_KeyHandler, ((2)|0x20000000), 0x00000002, (1), (0)}, {Default_KeyHandler, ((2)|0x10000000), 0x00000002, (1), (1)}, {Default_KeyHandler, ((2)|0x40000000), 0x00000002, (1), (2)}, {Default_KeyHandler, ((3)|0x20000000), 0x00000004, (1), (0)}, {Default_KeyHandler, ((3)|0x10000000), 0x00000004, (1), (1)}, {Default_KeyHandler, ((3)|0x40000000), 0x00000004, (1), (2)}, {Default_KeyHandler, ((4)|0x20000000), 0x00000008, (1), (0)}, {Default_KeyHandler, ((4)|0x10000000), 0x00000008, (1), (1)}, {Default_KeyHandler, ((4)|0x40000000), 0x00000008, (1), (2)}, {Default_KeyHandler, ((5)|0x20000000), 0x00000040, (1), (0)}, {Default_KeyHandler, ((5)|0x10000000), 0x00000040, (1), (1)}, {Default_KeyHandler, ((5)|0x40000000), 0x00000040, (1), (2)}, {Default_KeyHandler, ((6)|0x20000000), 0x00000080, (1), (0)}, {Default_KeyHandler, ((6)|0x10000000), 0x00000080, (1), (1)}, {Default_KeyHandler, ((6)|0x40000000), 0x00000080, (1), (2)}, {0, 0, 0, 0, 0} }; const UINT8 g_au8TriggerKeyStateIndex[] = {3,6};
...
void InputKey_Change(UINT32 u32InputStateIndex)
{
	...
	Keypad_InitTgr( (0), (0x00000001|0x00000002|0x00000004|0x00000008| 0x00000040|0x00000080),&g_asTriggerKeyHandler[g_au8TriggerKeyStateIndex[u32InputStateIndex]]); 


#line 40 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
	
#line 54 "..\\..\\..\\..\\Library\\Framework\\src\\ConfigIO.c"
}

void InputKey_Initiate(void)
{
	
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), ((0)|(0)), 0x3UL);	
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), (0), 0x1UL);	
	
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), ((0)|(0x00000001|0x00000002|0x00000004|0x00000008| 0x00000040|0x00000080)),  0x0UL);		
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), (0), 0x1UL);	
	
	
	if( (0) == 0 )
	{
		CLK_EnableModuleClock(((1UL<<30)|(1<<28)|( 7<<25)|(12<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(7)));
		CLK_SetModuleClock(((1UL<<30)|(1<<28)|( 7<<25)|(12<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(7)),(0x0UL<<(12)),0);
		TIMER_Open( ((TMR_T *) ((( uint32_t)0x40000000) + 0x10020)), (1UL << (27)), (100));
		TIMER_EnableInt(((TMR_T *) ((( uint32_t)0x40000000) + 0x10020)));
		NVIC_EnableIRQ(TMR1_IRQn);	
		TIMER_Start(((TMR_T *) ((( uint32_t)0x40000000) + 0x10020)));
	}

	
	Keypad_InitKeypad((0.0500)*TIMER_GetWorkingFreq(((TMR_T *) ((( uint32_t)0x40000000) + 0x10020))),(1.0000)*TIMER_GetWorkingFreq(((TMR_T *) ((( uint32_t)0x40000000) + 0x10020))));
...
{
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), (0x00001000|0x00002000|0x00004000|0x00008000),0x1UL);
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), (0x00000010|0x00000020),0x1UL);
	
	
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),0x00001000,0);
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),0x00002000,0);
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),0x00004000,0);
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),0x00008000,0);
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),0x00000010,1);
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),0x00000020,0);
}

void OutputPin_Set(GPIO_T *pPort, UINT16 u16PinMask, UINT8 u8Value)
{
	if (u8Value==1)
		((pPort)->DOUT = ((((pPort)->DOUT)|u16PinMask)));
	else
		((pPort)->DOUT = ((((pPort)->DOUT)&~u16PinMask)));
}
