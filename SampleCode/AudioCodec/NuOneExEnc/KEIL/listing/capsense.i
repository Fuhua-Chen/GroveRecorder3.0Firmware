#line 1 "..\\..\\..\\..\\Library\\StdDriver\\src\\capsense.c"
...
#line 12 "..\\..\\..\\..\\Library\\StdDriver\\src\\capsense.c"
...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\capsense.c"
...
void CapSense_SelectCurrentSourceValue( uint16_t u16SrcSel )
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CURCTL0 &= (~(0x3ul << (8)));
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CURCTL0 |= u16SrcSel;
}
...
void CapSense_SetCycleCounts( uint32_t u32Count, uint16_t u16LowTime )
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL &= (~ ( (0x7ul << (2)) | (0x3ul << (0)) )) ;
    ((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL |= ( u32Count << (2) );
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL |= u16LowTime;
}
...
void CapSense_ResetCounter(void)
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL |= (0x1ul << (29));
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL &= (~(0x1ul << (29))) ;
}
...
uint32_t CapSense_GetCounter(void)
{
    return (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCNT);
}
