...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\dpwm.c"
...
void DPWM_WriteFIFO(int16_t *pi16Stream, uint32_t u32count)
{
	...
	{
		while(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->STS == 1); 

		((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->DATA = *pi16Stream++;
		u32countRemain --;	
	}
}
...
uint32_t DPWM_SetSampleRate(uint32_t u32SampleRate)
{
	...
	if (u32Div>255)
		u32Div = 255;
	((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->ZOHDIV = u32Div;
	return (SystemCoreClock /(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->ZOHDIV*64));
}
