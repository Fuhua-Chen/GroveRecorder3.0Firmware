#line 1 "..\\NuOneExApp\\NuOneExApp_Decode.c"
...
#line 2 "..\\NuOneExApp\\NuOneExApp_Decode.c"
...
#line 3 "..\\NuOneExApp\\NuOneExApp_Decode.c"
#line 1 "..\\..\\..\\..\\Library\\Framework\\inc\\AudioRom.h"
...
#line 10 "..\\..\\..\\..\\Library\\Framework\\inc\\AudioRom.h"
...
#line 4 "..\\NuOneExApp\\NuOneExApp_Decode.c"
...
#line 5 "..\\NuOneExApp\\NuOneExApp_Decode.c"
...
void NuOneExApp_DecodeInitiate(S_NUONEEX_APP_DECODE *psNuOneExAppDecode, UINT8 *pau8TempBuf, UINT32 u32CallbackIndex)
{
	...
	((&psNuOneExAppDecode ->sOutBufCtrl)->u8Flag |= 2);
}
...
BOOL NuOneExApp_DecodeStartPlayByAddr(S_NUONEEX_APP_DECODE *psNuOneExAppDecode, UINT32 u32NuOneExStorageStartAddr, UINT8 u8PlaybackChannel)
{
	...
	psNuOneExAppDecode->sOutBufCtrl.u16BufWriteIdx = 320;
	if ( NuOneExApp_DecodeProcess(psNuOneExAppDecode) == 0 )
	{
		((&psNuOneExAppDecode ->sOutBufCtrl)->u8Flag |= 2);
		return 0;
	}
	psNuOneExAppDecode->sOutBufCtrl.u16BufReadIdx = 320;
...
BOOL NuOneExApp_DecodeProcess(S_NUONEEX_APP_DECODE *psNuOneExAppDecode)
{
	...
	if ((((&psNuOneExAppDecode ->sOutBufCtrl)->u8Flag & 2) != 0))
		return 0;
	...
	if ( Playback_NeedUpdateOutputBuf(&psNuOneExAppDecode->sOutBufCtrl) )
	{
		...
		if ( psNuOneExAppDecode->u8CtrlFlag&(1|2) )
		{
			if ( psNuOneExAppDecode->u8CtrlFlag & 1 )
				BufCtrl_WriteWithCount(psNuOneExAppDecode->psDuplicateOutBufCtrl, 320, pi16OutBuf );
			else 
				psNuOneExAppDecode->pfnDuplicateFunc(320, pi16OutBuf);
		}
	}	
	return 1;
}
