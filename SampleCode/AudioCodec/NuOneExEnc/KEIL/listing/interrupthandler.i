...
#line 18 "..\\InterruptHandler.c"
#line 19 "..\\InterruptHandler.c"



INT16 g_ai16DACSamples[(4*2)];
PINT16 Playback_Process(PINT16 pi16Buff);




INT16 g_ai16ADCSamples[(4*2)];
...
void PDMA_IRQHandler()
{
	...
	if ((*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHIF + (uint32_t)(((1))*0x100))))&(0x1ul << (1)))
	{
		(*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHIF + (uint32_t)(((1))*0x100))) = ((0x1ul << (1))));											
		Playback_Process(g_ai16DACSamples);	
	}

	

	if ((*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHIF + (uint32_t)(((0))*0x100))))&(0x1ul << (1)))
	{
		(*((volatile uint32_t *)((uint32_t)&((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHIF + (uint32_t)(((0))*0x100))) = ((0x1ul << (1))));
...
{
	TIMER_ClearIntFlag(((TMR_T *) ((( uint32_t)0x40000000) + 0x10000)));
...
{
	TIMER_ClearIntFlag(((TMR_T *) ((( uint32_t)0x40000000) + 0x10020)));
...
void GPAB_IRQHandler()
{
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->INTSRC = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->INTSRC & (0x00000008)));
