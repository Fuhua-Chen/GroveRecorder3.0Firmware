...
#line 13 "..\\..\\..\\..\\Library\\StdDriver\\src\\biq.c"
...
void BIQ_SetCoeff(uint32_t u32BiqCoeff[15])
{
    ...
    p32CoeffAdd = &((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->COEFF0;
     
    ((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->CTL &= (~(0x1ul << (2)));
    ((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->CTL |= ((0x1ul << (2)));
...
void BIQ_Reset(void)
{
	...
	((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->CTL |= (0x1ul << (3));
