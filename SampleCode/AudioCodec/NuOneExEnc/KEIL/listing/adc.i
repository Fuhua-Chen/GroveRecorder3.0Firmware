...
uint32_t ADC_GetSampleRate(void)
{
    ...
    switch(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DCICTL)
    {
        case 0:
            u32OSR=64;
            break;
    ...
    u32Div = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV0&0xff00) >> (16);
	u32ADCClk = CLK_GetHCLKFreq()/(u32Div+1);
    return (u32ADCClk/(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CLKDIV)/u32OSR);
}
...
void ADC_EnableInt(uint32_t u32Mask)
{
	if (u32Mask&(1))
	{
		...
		((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->PDMACTL = 0;
		((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->INTCTL |= (0x1ul << (31));
	}
	
	if (u32Mask&(2))
	{
		 
		((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CMP0 |= ((0x1ul << (7)));
	...
	if (u32Mask&(4))
	{
		...
		((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CMP1 |= ((0x1ul << (7)));
	...
	if (u32Mask&(8))
	{
		...
		((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->INTSTS |= ((0x1ul << (0)));
		((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->INTCTL |= ((0x1ul << (0)));
	}
}
...
{
	if (u32Mask&(2))
		return ((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CMP0&(0x1ul << (7));
	
	if (u32Mask&(4))
		return ((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CMP1&(0x1ul << (7));
	
	if (u32Mask&(8))
		return ((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->INTSTS&0x1;
...
void ADC_SetAMUX(uint32_t u32AMUXSel, uint32_t u32MUXPSel, uint32_t u32MUXNSel)
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MUXCTL &= 0x0000;
	
	if (u32AMUXSel == ((0x1ul << (13))))
	{ 
		((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MUXCTL |= ((0x1ul << (14))|((0x1ul << (13))));
	}
	else if (u32AMUXSel == ((0x1ul << (12))))
	{
		((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MUXCTL |= ((0x1ul << (14))|((0x1ul << (12))));
	}
	else if (u32AMUXSel == ((0xful << (8))|(0xfful << (0))))
	{
		((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MUXCTL |= ((0x1ul << (14))|u32MUXPSel|u32MUXNSel);
	}    
}
...
void ADC_SetGPIOChannel(uint32_t u32Mode)
{
	ADC_SetAMUX(((0xful << (8))|(0xfful << (0))), u32Mode&0x0f00, u32Mode&0x00ff);
	u32Mode = u32Mode >> 12;
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), u32Mode, 0x0UL); 
}
...
void ADC_EnableMICBias(uint32_t u32BiasSel)  
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MICBSEL = (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MICBSEL&0x0)|u32BiasSel;
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MICBEN = (0x1ul << (0));
} 
...
void ADC_DisableMICBias(void)  
{
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MICBSEL = 0x0;
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->MICBEN = 0x0;
}
...
int32_t ADC_SetPGAGaindB(int32_t i32PGAGainIndB)
{
	if(i32PGAGainIndB < -1200)
		...
		i32PGAGainIndB = 3525;
	i32PGAGainIndB = ((i32PGAGainIndB + 1200) / 75)&(0x3ful << (0));
	((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGAGAIN = i32PGAGainIndB;
...
int32_t ADC_SetALCMaxGaindB(int32_t i32MaxGaindB)
{
	...
	((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL = (((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL&~(0x7ul << (25)))|(i32MaxGaindB << (25));
...
int32_t ADC_SetALCMinGaindB(int32_t i32MinGaindB)
{
	...
	((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL = (((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL&~(0x7ul << (22)))|(i32MinGaindB << (22));
...
int32_t ADC_SetALCTargetLevel(int32_t i32TargetLevel)
{
	...
	((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL = (((ALC_T *) ((( uint32_t)0x40000000) + 0xB0048))->CTL&~(0xful << (13)))|(i32TargetLevel << (13));
...
int32_t ADC_GetPGAGaindB(void)
{
	...
	i32Gain = ((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGAGAIN;
	i32Gain >>= ((8));
