...
void RTC_32KCalibration(int32_t i32FrequencyX100)
{
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->FREQADJ = (uint32_t)((i32RegInt<<8) | i32RegFra);
...
void RTC_Open (S_RTC_TIME_DATA_T *sPt)
{
    ...
    if(((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->INIT != 0x1) {
        ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->INIT = 0xA5EB1357UL;

        while(((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->INIT != 0x1);
    }
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CAL = (uint32_t)g_u32Reg;
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TIME = (uint32_t)g_u32Reg;
...
void RTC_GetDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    g_u32loDay   = (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CAL & (0xful << (0)));
    ...
    g_u32loSec  =  (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TIME & (0xful << (0)));
...
void RTC_GetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    g_u32loDay   = (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CALM & (0xful << (0)));
    ...
    g_u32loSec    =  (((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TALM & (0xful << (0)));
...
void RTC_SetDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->WEEKDAY = sPt->u32DayOfWeek & (0x7ul << (0));
...
void RTC_SetAlarmDateAndTime(S_RTC_TIME_DATA_T *sPt)
{
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->CALM = (uint32_t)g_u32Reg;
    ...
    ((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TALM = (uint32_t)g_u32Reg;
...
void RTC_EnableWakeUp(void)
{
	...
	((RTC_T *) ((( uint32_t)0x40000000) + 0x08000))->TICK |= (0x1ul << (3));
}
...
void RTC_Close (void)
{
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->APBCLK0  &= ~(0x1ul << (5));
}
