...
#line 12 "..\\..\\..\\..\\Library\\IO\\src\\Keypad.c"
...
#line 13 "..\\..\\..\\..\\Library\\IO\\src\\Keypad.c"
...
#line 14 "..\\..\\..\\..\\Library\\IO\\src\\Keypad.c"
...
typedef struct
{
	S_KEYPAD_TOUCH_KEY_HANDLE	sKeyValue[(8)];
...
typedef struct
{
	GPIO_T*               psInGPIO;            
	GPIO_T*               psOutGPIO;           
	S_KEYPAD_KEY_HANDLER* psKeyHandler;        
	uint16_t*             pu16PinValueArray;   
	uint16_t              u16InPinMaskA;       
	uint16_t              u16InPinMaskB;       
	uint16_t              u16OutPinMaskA;      
	uint16_t              u16OutPinMaskB;      
	uint16_t              u16OutPinDebMask;    
	uint16_t              u16PinValueDiff;     
	uint8_t               u8KeyMode;           
	uint8_t               u8KeyPinValueIdx;    
}S_KEYPAD_KEY_CTRL_HANDLE;

typedef struct
{
	GPIO_T*               psGPIO;              
	S_KEYPAD_TGR_HANDLER* psTgrHandler;        
	uint16_t              u16PinMaskA;         
	uint16_t              u16PinMaskB;         
	uint16_t              u16PinValueA;        
	uint16_t              u16PinValueB;        
	uint16_t              u16PinValueDiff;     
	uint8_t               u8TgrMode;           
...
void Keypad_InitKeypad( uint16_t u16DebounceCount, uint16_t u16PressingCount )
{
	...
	(((GPIO_DB_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00180))->DBCTL = ((0x1ul << (5)) | 0x00000010UL | 6));
	...
	if (u16InKeyPinMask && u16OutKeyPinMask)
	{
		while( u16Mask > 0 )
		{
			...
			{			
				...
				((psOutGPIO)->DOUT = ((((psOutGPIO)->DOUT)&~u16Mask)));
				
				s_sKeypadKeyCtrlHandler.pu16PinValueArray[s_sKeypadKeyCtrlHandler.u8KeyPinValueIdx++] = ((psInGPIO)->PIN)&u16InKeyPinMask;
                    ...
                    const S_KEYPAD_KEY_HANDLER* psKeyHandler,uint16_t* pu16KeyPinValueBuf)
{
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->DBEN |= u16InPinMaskA);
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->DBEN |= u16InPinMaskB);
	...
	Keypad_InitKeyMatrixPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),s_sKeypadKeyCtrlHandler.u16InPinMaskA,((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),s_sKeypadKeyCtrlHandler.u16OutPinMaskA);
	Keypad_InitKeyMatrixPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),s_sKeypadKeyCtrlHandler.u16InPinMaskA,((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),s_sKeypadKeyCtrlHandler.u16OutPinMaskB);
	Keypad_InitKeyMatrixPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),s_sKeypadKeyCtrlHandler.u16InPinMaskB,((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),s_sKeypadKeyCtrlHandler.u16OutPinMaskA);
	Keypad_InitKeyMatrixPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),s_sKeypadKeyCtrlHandler.u16InPinMaskB,((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),s_sKeypadKeyCtrlHandler.u16OutPinMaskB);
}
...
void Keypad_ResetKey(void)
{
	s_sKeypadKeyCtrlHandler.psInGPIO = 0;
	s_sKeypadKeyCtrlHandler.psOutGPIO = 0;
	...
	if(u16OutPinMask && u16InPinMask)
	{
		while( u16Mask > 0 )
		{
			...
			{		
				...
				u16CurPinValue = ((psInGPIO)->PIN)&u16InPinMask;
				...
				if ( s_sKeypadKeyCtrlHandler.u8KeyMode != (2) &&
				...
				s_sKeypadKeyCtrlHandler.u8KeyMode = (u16Diff & u16CurPinValue) ? (1) : (0);
				s_sKeypadKeyCtrlHandler.u8KeyPinValueIdx++;
			}
			u16Mask <<= 1;
		}
...
{
	uint8_t u8InPort = (s_sKeypadKeyCtrlHandler.psInGPIO == ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))? 0 : 1;
	uint8_t u8OutPort = (s_sKeypadKeyCtrlHandler.psOutGPIO == ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))? 0 : 1;
	uint8_t u8i;
	
	for (u8i=0 ; s_sKeypadKeyCtrlHandler.psKeyHandler[u8i].m_pfnKey_Callback != 0 ; u8i++)
	{
...
uint8_t Keypad_ScanKey(void)
{
	...
	s_sKeypadKeyCtrlHandler.u8KeyPinValueIdx = 0;
	Keypad_ScanKeyPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), s_sKeypadKeyCtrlHandler.u16InPinMaskA, ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), s_sKeypadKeyCtrlHandler.u16OutPinMaskA);
	Keypad_ScanKeyPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), s_sKeypadKeyCtrlHandler.u16InPinMaskA, ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadKeyCtrlHandler.u16OutPinMaskB);
	Keypad_ScanKeyPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadKeyCtrlHandler.u16InPinMaskB, ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), s_sKeypadKeyCtrlHandler.u16OutPinMaskA);
	Keypad_ScanKeyPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadKeyCtrlHandler.u16InPinMaskB, ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadKeyCtrlHandler.u16OutPinMaskB);
	
	if (s_sKeypadKeyCtrlHandler.psInGPIO != 0 && s_u16KeyDebounceCounter == 0)
	{	
		...
		switch(s_sKeypadKeyCtrlHandler.u8KeyMode)
		{
			...
			case (0):
			s_sKeypadKeyCtrlHandler.u8KeyMode = (2);
...
void Keypad_InitTgr(uint16_t u16PinMaskA,uint16_t u16PinMaskB,const S_KEYPAD_TGR_HANDLER* psTgrHandler)
{
	...
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->DBEN |= u16PinMaskA);
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->DBEN |= u16PinMaskB);

	
	s_sKeypadTgrCtrlHandler.u16PinMaskA = u16PinMaskA;
	s_sKeypadTgrCtrlHandler.u16PinMaskB = u16PinMaskB;
	s_sKeypadTgrCtrlHandler.u16PinValueA = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->PIN)&u16PinMaskA;
	s_sKeypadTgrCtrlHandler.u16PinValueB = ((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->PIN)&u16PinMaskB;
...
void Keypad_ResetTgr(void)
{
	s_sKeypadTgrCtrlHandler.psGPIO = 0;
...
void Keypad_ScanTgrPort(GPIO_T* pGPIO,uint16_t u16PinMask,uint16_t* pu16PinValue)
{
	...
	if (u16PinMask == 0 || pGPIO == 0 ) 
		return;
	
	u16CurPinValue = ((pGPIO)->PIN)&u16PinMask;
	...
	if ( s_sKeypadTgrCtrlHandler.psGPIO == pGPIO              && 
		 s_sKeypadTgrCtrlHandler.u8TgrMode != (2) &&
	...
	else
	{
	    ...
	    *pu16PinValue = u16CurPinValue;
	    ...
	    s_sKeypadTgrCtrlHandler.u8TgrMode = (s_sKeypadTgrCtrlHandler.u16PinValueDiff & *pu16PinValue) ? (1) : (0);
	}
}
...
{
	uint8_t u8Port = (s_sKeypadTgrCtrlHandler.psGPIO == ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))? 0 : 1;
	uint8_t u8i;
	
	for (u8i=0 ; s_sKeypadTgrCtrlHandler.psTgrHandler[u8i].m_pfnTgr_Callback != 0 ; u8i++)
	{
...
uint8_t Keypad_ScanTgr(void)
{
	...
	Keypad_ScanTgrPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), s_sKeypadTgrCtrlHandler.u16PinMaskA, &s_sKeypadTgrCtrlHandler.u16PinValueA);
	Keypad_ScanTgrPort(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadTgrCtrlHandler.u16PinMaskB, &s_sKeypadTgrCtrlHandler.u16PinValueB);
	
	if (s_sKeypadTgrCtrlHandler.psGPIO != 0 && s_u16TgrDebounceCounter == 0)
	{
...
{
	do{
		if( (s_sKeypadTouchCtrlHandler.u8ScanIndex++) >= (8) )
...
uint8_t Keypad_TouchMapHandler(void)
{
	...
	for (u8i=0 ; s_sKeypadTouchCtrlHandler.psTouchHandler[u8i].m_pfnTouch_Callback != 0 ; u8i++)
	{
		if( ( s_sKeypadTouchCtrlHandler.psTouchHandler[u8i].m_u8Mode == (1) 																						&& 
			...
			( s_sKeypadTouchCtrlHandler.psTouchHandler[u8i].m_u8Mode == (0) 																						&&
		...
		else if ( s_sKeypadTouchCtrlHandler.psTouchHandler[u8i].m_u8Mode == (2) )
		{
...
void Keypad_TouchCaptureState(void)
{
	...
	{
		(psKeyHandler->u8Counter&(0x80))? (psKeyHandler->u8Counter++):(psKeyHandler->u8Counter|=(0x80));
		if(( (s_sKeypadTouchCtrlHandler.u16PadStatus&(1<<s_sKeypadTouchCtrlHandler.u8ScanIndex))==0 )&&(psKeyHandler->u8Counter>(2)))
		{
			s_sKeypadTouchCtrlHandler.u16PadStatus |= (1<<s_sKeypadTouchCtrlHandler.u8ScanIndex);
			psKeyHandler->u8Counter &= (0x80); 
		}
	...
	{
		(psKeyHandler->u8Counter&(0x80))? (psKeyHandler->u8Counter&=~(0x80)):(psKeyHandler->u8Counter++);
		if( ( (s_sKeypadTouchCtrlHandler.u16PadStatus&(1<<s_sKeypadTouchCtrlHandler.u8ScanIndex))!=0 ) && (psKeyHandler->u8Counter>(2)))
		{
			s_sKeypadTouchCtrlHandler.u16PadStatus &= ~(1<<s_sKeypadTouchCtrlHandler.u8ScanIndex);
			psKeyHandler->u8Counter&=(0x80);
		}
		if((psKeyHandler->i16LowerValue - psKeyHandler->i16CurrentValue)> (30))
		{
			psKeyHandler->u8TempCounter++;
			if( psKeyHandler->u8TempCounter>(2))
			{
				psKeyHandler->i16LowerValue -= (30);
...
void Keypad_TouchStartIRQ(void)
{
	...
	( ((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL |= (0x1ul << (30)) );
	( ((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CAPSCTL |= (0x1ul << (31)) );
}
...
void Keypad_TouchCalibration(void)
{
	...
	for( u8i=0; u8i<(8); u8i++)
    {
		...
		{
			((ACMP_T *) ((( uint32_t)0x40000000) + 0xD0000))->POSSEL = (s_sKeypadTouchCtrlHandler.u8ScanIndex)<<(0);
			((ACMP_T *) ((( uint32_t)0x40000000) + 0xD0000))->CTL0 &= (~(0x1ul << (4)));
			((ACMP_T *) ((( uint32_t)0x40000000) + 0xD0000))->CTL0 |= (0x1ul << (0));
			u32TmpCounter=0;
			...
			s_sKeypadTouchCtrlHandler.sKeyValue[u8i].i16CurrentValue = u32TmpCounter/(16);
...
void Keypad_InitTouch( uint16_t u16Pin, const S_KEYPAD_TOUCH_THRESHOLD* psThreshold, const S_KEYPAD_TOUCH_HANDLER* psTouchHandler, uint16_t* pu16TouchPinValueBuf )
{
	...
	s_sKeypadTouchCtrlHandler.u8ScanIndex = (8);
	
	Keypad_GetTouchEnablePin();
	
	GPIO_SetMode( ((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), s_sKeypadTouchCtrlHandler.u16EnablePin, 0x0UL ); 
	
	( ((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->CURCTL0 |= s_sKeypadTouchCtrlHandler . u16EnablePin );
	
	CapSense_SelectCurrentSourceValue(( 0x1UL<<(8) ));
	
    CapSense_SetCycleCounts( 4, ( 0x2UL ) );
