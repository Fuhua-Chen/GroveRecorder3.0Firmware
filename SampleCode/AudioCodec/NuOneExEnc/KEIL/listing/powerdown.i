...
#line 7 "..\\Powerdown.c"
#line 8 "..\\Powerdown.c"
#line 1 "..\\ConfigSysClk.h"



#line 5 "..\\ConfigSysClk.h"
#line 1 "..\\..\\..\\..\\Library\\Framework\\inc\\SysClk.h"



#line 5 "..\\..\\..\\..\\Library\\Framework\\inc\\SysClk.h"
...
{	
	...
	while( ++u32Tmp < (5000) )
	{
		while( ( (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->PIN)&u32GPAPinMask) != u32GPAPinMask) || 
			   ( (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->PIN)&u32GPBPinMask) != u32GPBPinMask) )
			u32Tmp = 0;
	}
...
{	
	...
	while(u32PinMask>>u8Tmp)
	{
		...
		{
			if(bEnable)
				GPIO_EnableInt(gpio, u8Tmp, 0x00010001UL);
			else
...
{			
	...
	PowerDown_GPIOStableCount((0),(0x00000008));
	(((GPIO_DB_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00180))->DBCTL = ((0x1ul << (5)) | 0x00000000UL | 0x00000003UL));
	
	
#line 77 "..\\Powerdown.c"
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), (0x00000008), 0x3UL);
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->DBEN |= (0x00000008));
	PowerDown_GPIOConfigWakePin(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),(0x00000008),1);
...
{		
	...
	PowerDown_GPIOConfigWakePin(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),(0x00000008),0);
...
{	
	...
	sTime.u32Month = (12);
	sTime.u32Day = (1);
	sTime.u32DayOfWeek = (((uint32_t) 0x00000001));
	sTime.u32Hour = (0);
	sTime.u32Minute = (0);
	sTime.u32Second = (0);
	sTime.u32TimeScale = 1;
	 
	CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(5)));
	CLK_SetModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(5)),0x0,0x0);	
	RTC_Open(&sTime);

	sTime.u32Year = (2014)+(0);
	sTime.u32Month = (12)+(0);
	sTime.u32Day = (1)+(0);
	sTime.u32Hour = (0)+(0);
	sTime.u32Minute = (0)+(0);
...
void PowerDown_RTCPostProc(void)
{
	...
	RTC_DisableInt((0x1ul << (0)));
	RTC_Close();			  					
	CLK_DisableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(5)));
}
...
{
	CLK_EnableModuleClock(((1UL<<30)|(1<<28)|( 3<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(4)));
	
	CLK_SetModuleClock(((1UL<<30)|(1<<28)|( 3<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(4)), (0x0UL<<(0)), 0x0); 	
	WDT_ResetCounter();
	WDT_ClearTimeOutIntFlag();
 	WDT_Open(((0UL << (8))), 0);
	WDT_EnableInt();
	NVIC_EnableIRQ(WDT_IRQn);
	CLK_SetModuleClock(((1UL<<30)|(1<<28)|( 3<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(4)), (0x3UL<<(0)), 0x0);
}
...
void PowerDown_WDTPostProc(void)
{
	...
	WDT_DisableInt();
	WDT_Close();
	CLK_DisableModuleClock(((1UL<<30)|(1<<28)|( 3<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(4)));
}
...
void PowerDown_Enter(void)
{
	...
	CLK_DisableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(12)));
	...
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )), (0)|(0)|(0)|(0x00001000|0x00002000|0x00004000|0x00008000), 0x1UL);
	GPIO_SetMode(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)), (0)|(0)|(0x00000001|0x00000002|0x00000004|0x00000008| 0x00000040|0x00000080)|(0x00000010|0x00000020), 0x1UL);
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->DOUT = (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )))->DOUT)|((0)|(0)|(0)|(0x00001000|0x00002000|0x00004000|0x00008000))));
	((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->DOUT = (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->DOUT)|((0)|(0)|(0x00000001|0x00000002|0x00000004|0x00000008| 0x00000040|0x00000080)|(0x00000010|0x00000020))));

	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP = 0;
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPB_MFP = 0;
...
{	
	...
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) )),0x00004000,0);
