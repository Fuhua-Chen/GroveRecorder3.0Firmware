...
#line 13 "..\\..\\..\\..\\Library\\Framework\\src\\SysClk.c"
...
UINT32 SysClk_InitiateRC(UINT32 u32SystemClk)
{
	...
	CLK_EnableXtalRC((0x1ul << (1))|(0x1ul << (2))|(0x1ul << (3)));

	 
	if( u32SystemClk == (32*1000000UL) )
	{
		CLK_SetHCLK((0x00UL<<(0)), (0x01UL<<(6)), (((1)-1) << (0)));
		
		return 32768000UL;
	}
	
	 
	if ( (u32SysClkDiv = (((49152000UL)))/u32SystemClk) == 0 )	
		u32SysClkDiv = 1;
	else if (u32SysClkDiv > 0x10)						
		u32SysClkDiv = 0x10;
	
	CLK_SetHCLK((0x00UL<<(0)), (0x00UL<<(6)), (((u32SysClkDiv)-1) << (0)));

	u32SystemClk = (((49152000UL)))/u32SysClkDiv;
