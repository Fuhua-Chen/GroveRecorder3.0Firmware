...
#line 25 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
#line 1 "..\\ConfigApp.h"
...
#line 26 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
...
#line 27 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
...
#line 28 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
...
#line 29 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
...
#line 42 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"

#line 50 "..\\..\\..\\..\\Library\\Framework\\src\\MicSpk.c"
...
static void BIQFilter_Setting(void)
{
	...
	CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(18)));
...
)
{
	...
	do{		
		...
		if ((((u8Div>=8)&&(u8Div<=48))?1:0))
			break;
	}while(++u8OSRIdx<4);

	(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DCICTL = (((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DCICTL&(~(0xful << (0))))|(u8OSRIdx&0xf));
	(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CLKDIV = (u8Div&0xff));
...
void MIC_Open(void)
{
	...
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGACTL = (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGACTL&~((0x1ul << (3))|(0x1ul << (0))))|((0x1ul << (1))|(0x1ul << (2))|(0x0ul << (0))|(0x1ul << (3))));
	ADC_SetPGAGaindB((600)); 
	...
	((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->PDMACTL |= (0x1ul << (0)); ((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->INTCTL &= (~(0x1ul << (31)));
	PdmaCtrl_Open((0), ((0x00000006UL<<24)|0x00100000UL|((0<<(12))|((0x1ul << (1))<<8))|0x00000020UL|0x00000000UL|0x00000004UL));
...
void MIC_Close(void)
{
	...
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGACTL = 0x0);
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->VMID |= 0x7);
	ADC_DisableMICBias();
	
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->SIGCTL &= ~(((0x1ul << (4)))| ((0x1ul << (3)))| ((0x1ul << (2)))| ((0x1ul << (1)))&(0x1F)));




	ADC_Close();
	CLK_DisableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|( 0xFF<<10)|(16<<5)|(28)));
}
...
)
{
	...
	(((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->CTL = (((BIQ_T *) ((( uint32_t)0x40000000) + 0xB0000))->CTL&~((0x1ffful << (16))|(0x7ul << (4))))|((0x1ul << (1))|((SystemCoreClock/u32SampleRate&0x1fff) << (16))|((3&0x7) << (4))));

	
	DPWM_SetSampleRate(u32SampleRate); 
}
...
void SPK_Open(void)
{
	...
	CLK_EnableModuleClock(((1UL<<30)|(1<<28)|( 1<<25)|( 4<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(13)));
	CLK_SetModuleClock(((1UL<<30)|(1<<28)|( 1<<25)|( 4<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(13)), (0x1UL<<(4)), 0x0);
	SYS_ResetModule(((0x4<<24) | (13) ));
	
	DPWM_Open();	 
	
	(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->CTL = (((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->CTL&~(0x7ul << (0)))|(0));
	
	BIQFilter_Setting();


	(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->DMACTL = 1);
	PdmaCtrl_Open((1), ((0x00000007UL<<24)|0x00100000UL|((0<<(12))|((0x1ul << (1))<<8))|0x00000000UL|0x00000080UL|0x00000008UL));
	...
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (24))) ) | (0x2UL<<(24));
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (26))) ) | (0x2UL<<(26));
...
void SPK_Start(void)
{
	...
	for( u8Count = 0; u8Count < 16; u8Count ++)
		((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->DATA =0;	

	(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->CTL |= (0x1ul << (6)));
}
...
void SPK_Close(void)
{
	...
	(((DPWM_T *) ((( uint32_t)0x40000000) + 0x70000))->DMACTL = 0);
	PdmaCtrl_Stop((1));
	PdmaCtrl_Close((1));

	
	CLK_DisableModuleClock(((1UL<<30)|(1<<28)|( 1<<25)|( 4<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(13)));
	
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (24))) );
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = (((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~(0x3ul << (26))) );
}
