                                  ...
                                  uint32_t u32CaptureEdge)
{
    ...
    uint32_t u32PWMClkTbl[4] = {(16000UL), (32768UL), 0, (49152000UL)};
    ...
    if(pwm == ((PWM_T *) ((( uint32_t)0x40000000) + 0x40000)))
        u32Src = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & ((0x3ul << (28)) << (u32ChannelNum >> 1))) >> ((28) << (u32ChannelNum >> 1));
    ...
    (pwm)->CLKPSC = ((pwm)->CLKPSC & ~((0xfful << (0)) << ((u32ChannelNum >> 1) * 8))) | (u16Prescale << ((u32ChannelNum >> 1) * 8));
    (pwm)->CLKDIV = ((pwm)->CLKDIV & ~((0x7ul << (0)) << (4 * u32ChannelNum))) | (u8Divider << (4 * u32ChannelNum));
    
    
    (pwm)->CTL |= (0x1ul << (3)) << (8 * u32ChannelNum);
    *((volatile uint32_t *)((((uint32_t) & ((pwm)->PERIOD0)) + (u32ChannelNum) * 12))) = u16CNR;
                                 ...
                                 uint32_t u32DutyCycle)
{
    ...
    (pwm)->CLKPSC = ((pwm)->CLKPSC & ~((0xfful << (0)) << ((u32ChannelNum >> 1) * 8))) | (u8Prescale << ((u32ChannelNum >> 1) * 8));
    (pwm)->CLKDIV = ((pwm)->CLKDIV & ~((0x7ul << (0)) << (4 * u32ChannelNum))) | (u8Divider << (4 * u32ChannelNum));
    
    
    (pwm)->CTL |= (0x1ul << (3)) << (8 * u32ChannelNum);
    *((volatile uint32_t *)((((uint32_t) & ((pwm)->CMPDAT0)) + u32ChannelNum * 12))) = u32DutyCycle * (u16CNR + 1) / 100 - 1;
    *((volatile uint32_t *)((((uint32_t) & ((pwm)->PERIOD0)) + (u32ChannelNum) * 12))) = u16CNR;
...
void PWM_Stop(PWM_T *pwm, uint32_t u32ChannelMask)
{
    ...
    for(i = 0; i < (2); i ++)
    {
        if(u32ChannelMask & (1 << i))
        {
            *((volatile uint32_t *)((((uint32_t) & ((pwm)->PERIOD0)) + i * 12))) = 0;
        }
    }
}
...
void PWM_EnableDeadZone(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Duration)
{
    ...
    (pwm)->CLKPSC = ((pwm)->CLKPSC & ~((0xfful << (16)) << (8 * u32ChannelNum))) | (u32Duration << ((16) + 8 * u32ChannelNum));
...
void PWM_ClearCaptureIntFlag(PWM_T *pwm, uint32_t u32ChannelNum, uint32_t u32Edge)
{
    ...
    if(u32ChannelNum < 2)
        (pwm)->CAPCTL01 = ((pwm)->CAPCTL01 & 0x000F000F) | ((0x1ul << (4)) << (u32ChannelNum * 16)) | (u32Edge << (u32ChannelNum * 16 + 5));
}
...
uint32_t PWM_GetCaptureIntFlag(PWM_T *pwm, uint32_t u32ChannelNum)
{
    if(u32ChannelNum < 2)
    {
        return (((pwm)->CAPCTL01 & (((0x1ul << (6)) | (0x1ul << (7))) << (u32ChannelNum * 16))) >> ((6) + u32ChannelNum * 16));
    }
    return 0;
}
