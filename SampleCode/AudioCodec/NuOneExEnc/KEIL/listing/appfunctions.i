...
#line 28 "..\\AppFunctions.c"
#line 1 "..\\..\\..\\..\\Library\\Framework\\inc\\SPIFlashUtil.h"
#line 4 "..\\..\\..\\..\\Library\\Framework\\inc\\SPIFlashUtil.h"
#line 5 "..\\..\\..\\..\\Library\\Framework\\inc\\SPIFlashUtil.h"
#line 6 "..\\..\\..\\..\\Library\\Framework\\inc\\SPIFlashUtil.h"
#line 7 "..\\..\\..\\..\\Library\\Framework\\inc\\SPIFlashUtil.h"
...
extern UINT32 g_u32SPIFlashRecAddr;	
...
{	
	...
	if ( NuOneExApp_DecodeStartPlayByAddr(&g_sApp.sNuOneExAppDecode, (1024*1024), 0) == 0)
		return 0;
	
	
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),0x00000010,1);
...
BOOL App_StopPlay(void)
{
	...
	OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),0x00000010,0);
...
{	
	...
	if (NuOneExApp_EncodeStart(&g_sApp.sNuOneExAppEncode, &sAudioChunkHeader, (12000), E_NUONEEX_ENCODE_BPS_10) == 0)
		return 0;
	
	
	
	SPIFlahUtil_StartWriteEncodeData(&sAudioChunkHeader, (1024*1024), 0);
...
BOOL App_ProcessPlay(void)
{
	...
	if ( NuOneExApp_DecodeProcess(&g_sApp.sNuOneExAppDecode) == 1 )
...
void App_ReadVRInit(void)
{
	...
	CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|( 0xFF<<10)|(16<<5)|(28)));
	CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(30)));
    SYS_ResetModule(((0x4<<24) | (28) ));
	SYS_ResetModule(((0x4<<24) | (30) ));
	
	 
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->SIGCTL = (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->SIGCTL&(~0x1F))|(((0x1ul << (4)))| ((0x1ul << (3)))| ((0x1ul << (2)))| ((0x1ul << (1)))&(0x1F)));
	...
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->SIGCTL |= (((0x1ul << (5)))&((0x1ul << (5))|(0x1ul << (6)))));
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->SIGCTL &= ~(((0x1ul << (6)))&((0x1ul << (5))|(0x1ul << (6)))));

	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGACTL = (((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->PGACTL&~((0x1ul << (3))|(0x1ul << (0))))|((0x1ul << (1))|(0x1ul << (2))|(0x0ul << (0))|(0x0ul << (3))));
	ADC_SetPGAGaindB(0); 


	 
	(((ANA_T *) ((( uint32_t)0x40000000) + 0x80000))->VMID = (0x0|(0x1ul << (2))|(0x0ul << (1))));
	ADC_EnableMICBias(((0x0ul << (2))|0x0));
	ADC_SetAMUX(((0x1ul << (13))), (0x0ul << (8)), (0x00ul << (0)));
	
	 
	ADC_Open();
	(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DCICTL = (((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DCICTL&(~(0xful << (0))))|(2&0xf));
	u32Div = CLK_GetHIRCFreq()/(12000)/192;
	(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CLKDIV = (u32Div&0xff));
	(((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->INTCTL = (((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->INTCTL&(~(0x7ul << (0))))|(7&0x7));
...
void App_ReadVR()
{
    ...
    ADC_SetGPIOChannel(((0x00000020 << 12) | (0x20ul << (0)) | (0x0ul << (8))));
            
    
    ADC_EnableInt((1));

    
    (((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->CHEN = (0x1ul << (0)));

    
    while(ADC_GetIntFlag((1)));
			
    for(j=0;j<=16;j++) {
        u32ConversionData = (((ADC_T*) ((( uint32_t)0x40000000) + 0xE0000))->DAT&0xffff);
