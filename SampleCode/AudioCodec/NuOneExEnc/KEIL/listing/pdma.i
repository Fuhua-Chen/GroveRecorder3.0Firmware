...
void PDMA_Open(uint32_t u32Mask)
{
    ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->GLOCTL |= (u32Mask << 8);
}
...
void PDMA_Close(void)
{
    ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->GLOCTL = 0;
}
...
void PDMA_SetTransferCnt(uint32_t u32Ch, uint32_t u32Width, uint32_t u32TransCount)
{
    ...
    pdma->DSCT_CTL = (pdma->DSCT_CTL & ~(0x3ul << (19))) | u32Width;
    switch(u32Width)
    {
    case 0x00000000UL:
...
void PDMA_SetTransferAddr(uint32_t u32Ch, uint32_t u32SrcAddr, uint32_t u32SrcCtrl, uint32_t u32DstAddr, uint32_t u32DstCtrl)
{
    ...
    pdma->DSCT_CTL = (pdma->DSCT_CTL & ~((0x3ul << (4)) | (0x3ul << (6)))) | (u32SrcCtrl | u32DstCtrl);
}
...
void PDMA_SetTransferDirection(uint32_t u32Ch, uint32_t u32Direction)
{
    ...
    pdma->DSCT_CTL = (pdma->DSCT_CTL & (~(0x3ul << (2))) ) | u32Direction ;
}
...
void PDMA_SetTransferMode(uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    {
    case 0x00000001UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (0))) | (u32Ch << (0));
        break;
    case 0x00000000UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (4))) | (u32Ch << (4));
        break;
    case 0x00000005UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (16))) | (u32Ch << (16));
        break;
    case 0x00000004UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (20))) | (u32Ch << (20));
        break;
    case 0x00000003UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (24))) | (u32Ch << (24));
        break;
    case 0x00000002UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (28))) | (u32Ch << (28));
        break;

    case 0x00000006UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (8))) | (u32Ch << (8));
        break;

    case 0x00000007UL:
        ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL = (((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & ~(0xful << (12))) | (u32Ch << (12));
        break;

    default: 
        for(u32Index = 0; u32Index < 8; u32Index++)
        {
            if((((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL & (0xF << (u32Index * 4))) == (u32Ch << (u32Index * 4)))
                ((PDMA_GCR_T *) ((( uint32_t)0x50000000) + 0x08F00))->SVCSEL |= 0xF << (u32Index * 4);
        }
    }
}
...
void PDMA_Trigger(uint32_t u32Ch)
{
    ...
    pdma->DSCT_CTL |= ((0x1ul << (23)) | (0x1ul << (0)));
}
