...
void  WDT_Open( uint32_t u32TimeoutInterval, uint32_t u32EnableReset )
{
    ...
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL = u32TimeoutInterval | (0x1ul << (7)) |(u32EnableReset << (1)) ;
	SYS_Lock(u8Lock);
}
...
void WDT_DisableInt(void)
{
    ...
    ((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL &= ~((0x1ul << (6)) | (0x1ul << (2)) | (0x1ul << (3))) ;
    SYS_Lock(u8Lock);
}
...
{
	uint8_t u8Lock = SYS_Unlock();	
	((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL = (((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL & ~(0x1ul << (3))) | (0x1ul << (2));
    SYS_Lock(u8Lock);
}
...
{
	uint8_t u8Lock = SYS_Unlock();	
	((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL = (((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL & ~(0x1ul << (2))) | (0x1ul << (3));	
	SYS_Lock(u8Lock);
}
...
{
	uint8_t u8Lock = SYS_Unlock();
	((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL  = (((WDT_T *) ((( uint32_t)0x40000000) + 0x04000))->CTL & ~((0x1ul << (3)) | (0x1ul << (2)))) | (0x1ul << (0));
	SYS_Lock(u8Lock);
}
