...
volatile UINT8 g_adcVR2volume;

volatile BOOL playEndStatus = 1;

volatile BOOL recEndStatus = 1;
...
{ 
	...
	((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP  = 
		(((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->GPA_MFP & (~((0x3ul << (0))|(0x3ul << (2))|(0x3ul << (4))|(0x3ul << (6)))) )
		| ((0x1UL<<(0))|(0x1UL<<(2))|(0x1UL<<(4))|(0x1UL<<(6)));	
	
	
	CLK_EnableModuleClock(((1UL<<30)|(0<<28)|(0x0<<25)|( 0<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(12)));
	SYS_ResetModule(((0x4<<24) | (12) ));
	SPIFlash_Open(((SPI_T *) ((( uint32_t)0x40000000) + 0x30000)), (0x1ul<<(0)), 12000000, &g_sSpiFlash );

	
	SPIFlash_PowerDown(&g_sSpiFlash, 0);
...
INT32 main()
{
	...
	while (1)
	{
		if ( g_u8AppCtrl&0x00000004 )
		{
			if ( App_ProcessRec() == 0 )
				App_StopRec();
		}
		else if ( g_u8AppCtrl&0x00000008 )
		{
			if ( App_ProcessPlay() == 0 )
				App_StopPlay();
		}
