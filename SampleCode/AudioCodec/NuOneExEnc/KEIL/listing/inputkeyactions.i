...
#line 19 "..\\InputKeyActions.c"
#line 20 "..\\InputKeyActions.c"
...
{
	if ( g_u8AppCtrl&(0x00000008|0x00000002) )
		return;
	...
	IsRunning = 1;
		...
		switch(u32Param)
		{
			...
			case ((3)|0x20000000):
				...
				while(1)
				{
					if(((((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->PIN) & 0x00000004 ) == 0x00000004) && ( App_ProcessPlay() == 0 ))
					{
							App_StopPlay();
							OutputPin_Set(((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)),0x00000010,1);
							Playback_KeypadHandler(1);  
						  break;
					}
			  }
				break;
			...
			case ((4)|0x20000000):  
				...
				printf("Start Rec.\n\r");
				while((((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->PIN) & 0x00000008 ) != 0x00000008)
				{
					if ( App_ProcessRec() == 0 )
						App_StopRec();
				}
			...
			case ((5)|0x20000000):
				printf("TG5F...\n\r");
				if(playEndStatus) {
					while( (((((GPIO_T *) (((( uint32_t)0x50000000) + 0x04000) + 0x00040)))->PIN) & 0x00000040 ) != 0x00000040)
					{
						delay_ms(10);	 
						if( (u32Tmp++) >= 100)
						{
