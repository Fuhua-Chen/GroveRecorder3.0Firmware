...
// Application handler.
S_APP g_sApp;
// Application setting volumeDB by ADC read VR
volatile UINT8 g_adcVR2volume;
// playEndStatus is to prevent the trouble when playing 
volatile BOOL playEndStatus = TRUE;
// recEndStatus is to prevent the trouble when recording 
volatile BOOL recEndStatus = TRUE;
